  ...
  <body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
    ...
    <div class="app-wrapper">
      ...
      <nav class="app-header navbar navbar-expand bg-body">
        ...
        <div class="container-fluid">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-md-block"><a href="{{ route('dashboard') }}" class="nav-link">الريئسية</a></li>
            {{-- <li class="nav-item d-none d-md-block"><a href="{{ route('contact.index') }}" class="nav-link">Contact</a></li> --}}
          </ul>
      ...
      <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark" >
        <!--begin::Sidebar Brand-->
        <div class="sidebar-brand  text-bg-primary">
          <!--begin::Brand Link-->
          <a href="{{ route('dashboard') }}" class="brand-link">
            ...
            <!--end::Brand Image-->
            <!--begin::Brand Text-->
            <span class="brand-text fw-light">تطبيق بنك الدم </span>
            <!--end::Brand Text-->
          </a>
          <!--end::Brand Link-->
        </div>
